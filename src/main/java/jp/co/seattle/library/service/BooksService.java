...
public class BooksService {
	...
	public int registBook(BookDetailsInfo bookInfo) {
		...
		String sql = "INSERT INTO books (title, author, publisher, publish_date, thumbnail_name, thumbnail_url, isbn, description, reg_date, upb_date)VALUES(?,?,?,?,?,?,?,?,now(),now()) RETURNING id";
